...
drop policy if exists "authenticated can read medals" on public.awards;
...
drop policy if exists "authenticated can read personnel medals" on public.personnel_awards;
...
drop policy if exists "medal staff can remove medals" on public.personnel_awards;
