...
revoke all on public.app_page_permissions from public;
revoke all on public.user_page_permissions from public;
...
values
  ...
  ('operations.server-bookings', '/servers', 'Server Booking', 'Operations', 'Create and cancel Arma server bookings.')
...
with legacy_role_permissions(role_name, permission_key) as (
  values
    ('admin', 'admin.create'), ('recruiter', 'admin.create'),
    ('admin', 'admin.positions'), ('nco', 'admin.positions'), ('di', 'admin.positions'),
    ('admin', 'admin.certifications'), ('nco', 'admin.certifications'), ('trainer', 'admin.certifications'),
    ('admin', 'admin.medals'), ('nco', 'admin.medals'), ('di', 'admin.medals'),
    ('recruiter', 'admin.medals'), ('akhari', 'admin.medals'),
    ('admin', 'admin.weekly-attendance'), ('nco', 'admin.weekly-attendance'),
    ('admin', 'admin.discord-attendance'), ('nco', 'admin.discord-attendance'), ('akhari', 'admin.discord-attendance'),
    ('admin', 'admin.removal'), ('nco', 'admin.removal'),
    ('admin', 'admin.removal-log'), ('nco', 'admin.removal-log'), ('recruiter', 'admin.removal-log'),
    ('admin', 'admin.discord-announcements'), ('akhari', 'admin.discord-announcements'),
    ('servermaintenance', 'admin.server-control'), ('akhari', 'admin.server-control'),
    ('admin', 'admin.permissions'), ('akhari', 'admin.permissions'),
    ('akhari', 'gc.asset-log'), ('logistics', 'gc.asset-log'),
    ('akhari', 'gc.logistics'), ('logistics', 'gc.logistics'), ('admin', 'gc.logistics'),
    ('akhari', 'cis.logistics'), ('logistics', 'cis.logistics'),
    ('admin', 'personnel.command-dashboard'), ('nco', 'personnel.command-dashboard'),
    ('di', 'personnel.command-dashboard'), ('trainer', 'personnel.command-dashboard'),
    ('recruiter', 'personnel.command-dashboard'), ('akhari', 'personnel.command-dashboard'),
    ('admin', 'operations.planops'), ('logistics', 'operations.planops'),
    ('nco', 'operations.planops'), ('trainer', 'operations.planops'),
    ('admin', 'operations.server-bookings'), ('nco', 'operations.server-bookings'),
    ('trainer', 'operations.server-bookings'), ('akhari', 'operations.server-bookings')
)
insert into public.user_page_permissions (user_id, permission_key, access_level)
select distinct ur.user_id, legacy.permission_key, 'full'
from public.user_roles ur
join legacy_role_permissions legacy on lower(ur.role) = legacy.role_name
