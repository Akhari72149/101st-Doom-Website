  ...
  select least(
    ...
    greatest(
      ...
      case upper(coalesce(p_medical_metric, ''))
        ...
        when 'FRACTURE_CHECKED' then 5
        when 'ULTRASOUND_SCAN' then 5
        when 'CHEST_SEAL_APPLIED' then 8
...
returns table (
  ...
  lifetime_fracture_check_count integer,
  lifetime_ultrasound_scan_count integer,
  lifetime_chest_seal_count integer,
  ...
  week_fracture_check_count integer,
  week_ultrasound_scan_count integer,
  week_chest_seal_count integer,
...
begin
  ...
  if found then
    ...
    select
      ...
      profile.lifetime_fracture_check_count,
      profile.lifetime_ultrasound_scan_count,
      profile.lifetime_chest_seal_count
    into
    ...
    select
      ...
      weekly.week_fracture_check_count,
      weekly.week_ultrasound_scan_count,
      weekly.week_chest_seal_count,
  ...
  set
    ...
    week_fracture_check_count = case when public.personnel_medical_weekly_stats.week_start_date = excluded.week_start_date then public.personnel_medical_weekly_stats.week_fracture_check_count else 0 end,
    week_ultrasound_scan_count = case when public.personnel_medical_weekly_stats.week_start_date = excluded.week_start_date then public.personnel_medical_weekly_stats.week_ultrasound_scan_count else 0 end,
    week_chest_seal_count = case when public.personnel_medical_weekly_stats.week_start_date = excluded.week_start_date then public.personnel_medical_weekly_stats.week_chest_seal_count else 0 end,
  ...
  set
    ...
    lifetime_fracture_check_count = profile.lifetime_fracture_check_count + case when v_metric = 'FRACTURE_CHECKED' then v_quantity::integer else 0 end,
    lifetime_ultrasound_scan_count = profile.lifetime_ultrasound_scan_count + case when v_metric = 'ULTRASOUND_SCAN' then v_quantity::integer else 0 end,
    lifetime_chest_seal_count = profile.lifetime_chest_seal_count + case when v_metric = 'CHEST_SEAL_APPLIED' then v_quantity::integer else 0 end,
    last_event_at = greatest(coalesce(profile.last_event_at, p_occurred_at), p_occurred_at),
    updated_at = now()
  where profile.personnel_id = v_personnel_id;
  ...
  set
    ...
    week_fracture_check_count = weekly.week_fracture_check_count + case when v_metric = 'FRACTURE_CHECKED' then v_quantity::integer else 0 end,
    week_ultrasound_scan_count = weekly.week_ultrasound_scan_count + case when v_metric = 'ULTRASOUND_SCAN' then v_quantity::integer else 0 end,
    week_chest_seal_count = weekly.week_chest_seal_count + case when v_metric = 'CHEST_SEAL_APPLIED' then v_quantity::integer else 0 end,
    last_event_at = greatest(coalesce(weekly.last_event_at, p_occurred_at), p_occurred_at),
    updated_at = now()
  where weekly.personnel_id = v_personnel_id;
